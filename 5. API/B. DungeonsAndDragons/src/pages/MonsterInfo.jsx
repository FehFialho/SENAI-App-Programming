...
export const MonsterInfo = () => {
  ...
  return (
    <>
      <section className="flex flex-row items-center w-full h-full">
            <section className="flex flex-col justify-between w-1/3 h-1/2 m-3">
                {/* Name */}
                <h2 className="bg-amber-300 text-center font-bold text-2xl p-2">{details.name}</h2>
                {/* Image */}
                {details.image && (
                <img
            ...
            {/* Info */}
            <section 
                className="flex flex-col justify-center items-center bg-amber-200 w-1/3 h-1/2">
